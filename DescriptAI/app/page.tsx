...
import { ThemeText } from "@/components/DynamicTheme";
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="glass-input w-full px-4 py-3 rounded-xl border border-white/10 focus:outline-none focus:border-green-500 transition"
          />
        </div>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-hidden" style={{ color: 'var(--dynamic-text, #ffffff)' }}>
      {/* CSS Animations */}
      <style jsx global>{`
        @keyframes float {
      ...
      <header className="container mx-auto px-4 py-6 sticky top-0 z-50 backdrop-blur-xl glass-dynamic border-b border-white/10" style={{ color: 'var(--dynamic-text, #ffffff)' }}>
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a href="#features" className="text-gray-400 theme-link-hover font-medium transition">
              Features
            </a>
            <a href="#how-it-works" className="text-gray-400 theme-link-hover font-medium transition">
              How It Works
            </a>
      ...
      <section className="container mx-auto px-4 py-20 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight glass-text px-6 py-3 rounded-2xl inline-block" style={{ color: 'var(--dynamic-text, #ffffff)' }}>
          ...
          {/* Dynamic Theme Text - Changes hourly with colors */}
          <div className="mb-6">
            <ThemeText />
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div 
                key={index}
                className="glass-card-premium glass-hover p-6"
                style={{
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="relative">
                ...
                <TiltCard className="glass-card-premium p-8 text-center relative z-10">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-center gap-8">
            {[
              ...
              <div key={index} className="glass-badge flex items-center gap-3 px-4 py-2">
                <svg className="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <div>
      ...
      <section id="testimonials" className="py-20 relative z-10">
        <div className="container mx-auto px-4">
          ...
          {/* Email Waitlist CTA */}
          <div className="glass-dynamic rounded-3xl p-8 md:p-12 mb-16 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white via-yellow-200 to-white bg-clip-text text-transparent">
              Get Early Access to Pro Features
            </h2>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join our waitlist to get <span className="text-green-400 font-bold">50% OFF</span> Pro plan when we launch bulk generation, AI personas, and white-label options.
            </p>
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => {
              e.preventDefault();
              const email = (e.target as HTMLFormElement).email.value;
              alert('Thanks! You\'re on the list. We\'ll email you at ' + email);
            }}>
              <input 
                name="email"
                type="email" 
                ...
                required
                className="glass-input flex-1 px-4 py-3 rounded-xl border border-white/10 focus:outline-none focus:border-green-500 transition text-white placeholder-gray-500"
              />
              <button 
                type="submit"
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold hover:from-green-600 hover:to-emerald-700 transition-all transform hover:scale-105"
              >
                Join Waitlist
              </button>
            </form>
            <p className="text-gray-500 text-sm mt-3">
              🔒 No spam. Unsubscribe anytime. <span className="text-green-400">247 users already joined!</span>
            </p>
          </div>

          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white via-yellow-200 to-white bg-clip-text text-transparent">
              Loved by E-commerce Experts
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Join 1,000+ sellers who have transformed their product listings
            </p>
          </div>
            ...
            {[
              {
                ...
                role: "Amazon Seller",
                avatar: "👩‍💼",
                content: "DescriptAI saved me 20+ hours per week writing descriptions. My conversion rate increased by 35%!",
                rating: "⭐⭐⭐⭐⭐"
              },
              {
                name: "Mike Johnson",
                ...
                avatar: "👨‍💻",
                content: "The SEO-optimized descriptions boosted my organic traffic by 200%. Worth every penny!",
                rating: "⭐⭐⭐⭐⭐"
              },
              {
                name: "Lisa Park",
                role: "Etsy Crafts",
                avatar: "👩‍🎨",
                content: "Finally, descriptions that match my handcrafted products' quality. Game changer!",
                rating: "⭐⭐⭐⭐⭐"
              }
            ].map((testimonial, index) => (
              <div key={index} className="glass-card-premium p-6 rounded-2xl">
                <div className="flex items-center gap-1 mb-4">{testimonial.rating}</div>
