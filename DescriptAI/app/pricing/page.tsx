...
const getPricingTiers = (isIndia: boolean, isAnnual: boolean): PricingTier[] => [
    ...
    },
    {
        ...
        period: "/mo",
        description: "For agencies & high-volume teams - Start earning today!",
        features: [
            "♾️ Unlimited AI Generations",
            "📊 Bulk Generation (1000+ at once)",
            "🏆 Agency Command Suite",
            "🎨 Custom Brand Voice Presets",
            "🏷️ FULL WHITE-LABEL - Remove All Branding",
...
const comparisonFeatures = [
    ...
    { feature: "Bulk Generation", free: "❌ Single only", pro: "✅ 50 descriptions", agency: "✅ 1,000+ descriptions" },
    ...
    { feature: "White-Label (Remove Branding)", free: "❌", pro: "❌", agency: "✅ FULL White-Label" },
    { feature: "Custom Subdomain", free: "❌", pro: "❌", agency: "✅ yourbrand.descriptai.com" },
    { feature: "Multi-Client Portal", free: "❌", pro: "❌", agency: "✅ Unlimited clients" },
    { feature: "Reseller & Invoicing", free: "❌", pro: "❌", agency: "✅ Generate client invoices" },
    { feature: "Team Seats", free: "❌", pro: "❌", agency: "✅ 50 team members" },
    { feature: "Role-Based Permissions", free: "❌", pro: "❌", agency: "✅ Admin/Manager/Writer/Viewer" },
    { feature: "Approval Workflows", free: "❌", pro: "❌", agency: "✅ Senior review before publish" },
    { feature: "Zapier Integration", free: "❌", pro: "❌", agency: "✅ Full Zapier + Make.com" },
    { feature: "API Access", free: "❌", pro: "❌", agency: "✅ Full REST API + Webhooks" },
    { feature: "Priority Support", free: "Standard", pro: "✅ Priority support", agency: "✅ Slack + Dedicated Manager" },
    { feature: "Custom Feature Requests", free: "❌", pro: "❌", agency: "✅ We build it for you!" }
];
...
export default function PricingPage() {
    ...
    useEffect(() => {
        const detectCountry = async () => {
            try {
                ...
                setIsIndia(india);
                setPaymentGateway("Razorpay"); // Always use Razorpay for India + Worldwide
            } catch {
                // Default to Razorpay
                setIsIndia(true);
    ...
    const handleUpgrade = async (tierName: string) => {
        alert("handleUpgrade called with tier: " + tierName);
        console.log("handleUpgrade called with tier:", tierName);
        if (tierName === "Free") {
        ...
        // Allow demo checkout even for non-signed-in users
        if (!isSignedIn) {
            console.log("User not signed in, allowing demo checkout");
                        ...
                        >
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    window.location.href = `/checkout?plan=${tier.name.toLowerCase()}&billing=${isAnnual ? 'annual' : 'monthly'}`;
                                }}
