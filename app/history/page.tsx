        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-100 via-white to-teal-100">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-4 mb-8 border border-purple-100">
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <select
                                ...
                                className="px-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition"
                            >
                                ...
                                {isExporting && (
                                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-2xl border border-gray-100 z-[60] py-2 overflow-hidden">
                                        <button 
                                            ...
                                            className="w-full text-left px-4 py-2 text-sm font-bold text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition"
                                        >
                                            General View
                                        </button>
                                        <button
                        ...
                        <>
                            ...
                            <div className="space-y-6">
                                {filteredHistory.map((item, index) => (
                                    <div key={item.id || index} className="bg-white rounded-xl shadow-md border border-purple-50 hover:shadow-lg transition overflow-hidden">
                                        <div className="p-6">
