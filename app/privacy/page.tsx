                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-amber-100">
                        ...
                        <div className="prose prose-purple max-w-none">
                            ...
                            <section className="mb-8">
                                ...
                                <p className="text-gray-800 leading-relaxed mt-4">
                                    To exercise these rights, contact us at <a href="mailto:privacy@descriptai.com" className="text-amber-700 hover:underline">privacy@descriptai.com</a>
                                </p>
                            </section>
                            ...
                            <section className="mb-8">
                                ...
                                <div className="bg-amber-50 rounded-xl p-6 mt-4 border border-amber-100">
                                    ...
                                    <p className="text-gray-800">Email: <a href="mailto:privacy@descriptai.com" className="text-amber-700 hover:underline">privacy@descriptai.com</a></p>
