    ...
    <TiltCard className="rounded-2xl bg-white/5 border border-white/10 p-8">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full py-4 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isGenerating ? (
            <>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-pink-600/20 via-transparent to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <header className="container mx-auto px-4 py-6 sticky top-0 z-50 backdrop-blur-xl bg-black/20 border-b border-white/5">
        <nav className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded-full font-semibold shadow-lg shadow-purple-500/20">
              PREMIUM AI ENGINE
            </span>
          </div>
          <div className="hidden md:flex items-center space-x-6">
            ...
            <SignedOut>
              ...
              <Link
                href="/sign-up"
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 rounded-lg hover:opacity-90 transition shadow-lg shadow-purple-500/20 font-semibold"
              >
                Sign Up Free
              </Link>
            </SignedOut>
          ...
          <div className="md:hidden mt-4">
            <div className="flex flex-col space-y-4">
              ...
              <SignedOut>
                ...
                <Link
                  href="/sign-up"
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 rounded-lg hover:opacity-90 transition shadow-lg shadow-purple-500/20 font-semibold text-center"
                >
                  Sign Up Free
                </Link>
              </SignedOut>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            >
              <div className="absolute inset-0 gradient-border rounded-xl p-[2px]">
                <div className="absolute inset-[2px] bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl group-hover:opacity-90 transition"></div>
              </div>
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              { value: 2.4, suffix: "M+", label: "Descriptions Generated", color: "text-purple-400" },
              ...
              { value: 1000, suffix: "+", label: "Active Sellers", color: "text-purple-400" },
            ].map((stat, index) => (
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            {/* After */}
            <TiltCard className="rounded-2xl bg-gradient-to-b from-purple-500/10 to-pink-500/10 border border-purple-500/30 p-6">
              <div className="flex items-center justify-between mb-4">
                <span className="bg-green-500/20 text-green-400 px-3 py-1 rounded-full text-sm font-bold">AFTER</span>
                <span className="text-purple-400 text-sm">DescriptAI Generated</span>
              </div>
              <h4 className="font-bold text-white mb-3">Premium Wireless Bluetooth Earbuds</h4>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="relative">
                {/* Connector Line */}
                {index < 2 && (
                  <div className="hidden md:block absolute top-12 left-full w-full h-0.5 bg-gradient-to-r from-purple-500/50 to-transparent z-0" style={{ width: 'calc(100% - 3rem)' }}></div>
                )}
                <TiltCard className="rounded-2xl bg-white/5 border border-white/10 p-8 text-center relative z-10">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 flex items-center justify-center mx-auto mb-6 text-2xl font-black text-white shadow-lg shadow-purple-500/30">
                    {item.step}
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg shadow-purple-500/30">
                  MOST POPULAR
                </span>
              </div>
              ...
              <TiltCard className="relative rounded-2xl bg-gradient-to-b from-white/10 to-white/5 border-2 border-purple-500/50 p-6 shadow-2xl shadow-purple-500/20">
                ...
                <Link href="/pricing" className="block w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-center hover:opacity-90 transition shadow-lg shadow-purple-500/30">
                  Upgrade to Pro
                </Link>
              </TiltCard>
            </div>
      ...
      <section className="py-20 relative z-10">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <Link
              href="/generate"
              className="inline-block px-10 py-5 rounded-xl bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 text-white text-lg font-bold hover:opacity-90 transition shadow-2xl shadow-purple-500/30"
            >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/generate" className="text-gray-400 hover:text-purple-400 transition">Generate</Link></li>
                <li><Link href="/pricing" className="text-gray-400 hover:text-purple-400 transition">Pricing</Link></li>
                <li><Link href="/help" className="text-gray-400 hover:text-purple-400 transition">Help Center</Link></li>
                <li><Link href="/history" className="text-gray-400 hover:text-purple-400 transition">History</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/terms" className="text-gray-400 hover:text-purple-400 transition">Terms of Service</Link></li>
                <li><Link href="/refund" className="text-gray-400 hover:text-purple-400 transition">Refund Policy</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:support@descriptai.com" className="text-gray-400 hover:text-purple-400 transition">support@descriptai.com</a></li>
                <li><a href="https://twitter.com/descriptai" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition">Twitter</a></li>
                <li><Link href="/contact" className="text-gray-400 hover:text-purple-400 transition">Contact Form</Link></li>
              </ul>
            </div>
          </div>
