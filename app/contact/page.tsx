                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
                            Get in <span className="bg-gradient-to-r from-amber-700 to-amber-600 bg-clip-text text-transparent">Touch</span>
                        </h1>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-12">
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-amber-100 text-center">
                            ...
                            <a href="mailto:support@descriptai.com" className="text-amber-700 hover:underline font-medium">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-amber-100 text-center">
                            ...
                            <a href="https://twitter.com/descriptai" target="_blank" rel="noopener noreferrer" className="text-amber-700 hover:underline font-medium">
                                @descriptai
                            </a>
                        </div>
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-amber-100 text-center">
                            ...
                            <a href="https://linkedin.com/company/descriptai" target="_blank" rel="noopener noreferrer" className="text-amber-700 hover:underline font-medium">
                                DescriptAI
                            </a>
                        </div>
                    </div>
                    ...
                    {submitted ? (
                        <div className="bg-white rounded-2xl shadow-xl p-8 border border-amber-100 text-center">
                            ...
                            <Link 
                                href="/"
                                className="bg-gradient-to-r from-amber-700 to-amber-600 text-white px-6 py-3 rounded-xl font-bold hover:shadow-lg transition"
                            >
                                Back to Home
                            </Link>
                        </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-amber-600 focus:ring-2 focus:ring-amber-200 outline-none transition"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-amber-600 focus:ring-2 focus:ring-amber-200 outline-none transition resize-none"
                                ...
                                <button
                                    ...
                                    className="w-full bg-gradient-to-r from-amber-700 to-amber-600 text-white py-4 rounded-xl font-bold hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                    ...
                    {/* FAQ Teaser */}
                    <div className="mt-12 bg-amber-50 rounded-2xl p-8 border border-amber-100 text-center">
                        ...
                        <Link 
                            href="/help"
                            className="inline-block bg-white text-amber-700 px-6 py-3 rounded-xl font-bold hover:bg-amber-100 transition border border-amber-200"
                        >
                            Visit Help Center
                        </Link>
                    </div>
