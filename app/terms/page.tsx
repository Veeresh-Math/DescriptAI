                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-purple-100">
                        ...
                        <div className="prose prose-purple max-w-none">
                            ...
                            <section className="mb-8">
                                ...
                                <p className="text-gray-800 leading-relaxed">You agree NOT to use the Service to:</p>
                                <ul className="list-disc list-inside text-gray-800 space-y-2 mt-4">
                            ...
                            <section className="mb-8">
                                ...
                                <div className="bg-purple-50 rounded-xl p-6 mt-4 border border-purple-100">
                                    ...
                                    <p className="text-gray-800">Email: <a href="mailto:legal@descriptai.com" className="text-purple-600 hover:underline">legal@descriptai.com</a></p>
