    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-teal-50">
                        ...
                        {filteredFAQs.map((item, index) => (
                            ...
                            >
                                <button
                                    ...
                                    className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-purple-50 transition"
                                >
            ...
            <section className="container mx-auto px-4 py-16">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl p-8 md:p-12 text-white text-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                                ...
                                <a href="mailto:support@descriptai.com" className="text-purple-200 hover:text-white transition">
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                                ...
                                <a href="https://twitter.com/descriptai" target="_blank" rel="noopener noreferrer" className="text-purple-200 hover:text-white transition">
                                    @descriptai
                                </a>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                                ...
                                <a href="https://linkedin.com/company/descriptai" target="_blank" rel="noopener noreferrer" className="text-purple-200 hover:text-white transition">
                                    DescriptAI
                                </a>
                            </div>
                        </div>
