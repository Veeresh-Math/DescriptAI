        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-emerald-50">
            ...
            <section className="container mx-auto px-4 py-16 text-center">
                <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
                    How can we <span className="bg-gradient-to-r from-amber-700 to-amber-600 bg-clip-text text-transparent">help you?</span>
                </h1>
                ...
                <div className="max-w-2xl mx-auto mb-12">
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-6 py-4 rounded-2xl border-2 border-amber-100 focus:border-amber-600 focus:ring-4 focus:ring-amber-100 outline-none transition text-lg shadow-lg"
                        />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                    <Link href="/pricing" className="bg-white rounded-xl p-6 shadow-md border border-amber-100 hover:shadow-lg hover:border-amber-300 transition">
                        <div className="text-3xl mb-2">💰</div>
                        <div className="font-bold text-gray-900">Pricing</div>
                        <div className="text-sm text-gray-700">View plans</div>
                    </Link>
                    <Link href="/refund" className="bg-white rounded-xl p-6 shadow-md border border-amber-100 hover:shadow-lg hover:border-amber-300 transition">
                        <div className="text-3xl mb-2">🔄</div>
                        <div className="font-bold text-gray-900">Refunds</div>
                        <div className="text-sm text-gray-700">30-day policy</div>
                    </Link>
                    <a href="mailto:support@descriptai.com" className="bg-white rounded-xl p-6 shadow-md border border-amber-100 hover:shadow-lg hover:border-amber-300 transition">
                        <div className="text-3xl mb-2">📧</div>
                        <div className="font-bold text-gray-900">Email Us</div>
                        <div className="text-sm text-gray-700">Get support</div>
                    </a>
                    <Link href="/generate" className="bg-white rounded-xl p-6 shadow-md border border-amber-100 hover:shadow-lg hover:border-amber-300 transition">
                        <div className="text-3xl mb-2">🚀</div>
                        ...
                        {filteredFAQs.map((item, index) => (
                            ...
                            >
                                <button
                                    ...
                                    className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-amber-50 transition"
                                >
            ...
            <section className="container mx-auto px-4 py-16">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-br from-amber-700 to-amber-600 rounded-3xl p-8 md:p-12 text-white text-center">
