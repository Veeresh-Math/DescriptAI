        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
            ...
            <section className="container mx-auto px-4 py-16 text-center">
                <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
                    How can we <span className="bg-gradient-to-r from-blue-700 to-cyan-600 bg-clip-text text-transparent">help you?</span>
                </h1>
                ...
                <div className="max-w-2xl mx-auto mb-12">
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-6 py-4 rounded-2xl border-2 border-blue-100 focus:border-blue-600 focus:ring-4 focus:ring-blue-100 outline-none transition text-lg shadow-lg"
                        />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                    <Link href="/pricing" className="bg-white rounded-xl p-6 shadow-md border border-blue-100 hover:shadow-lg hover:border-blue-300 transition">
                        <div className="text-3xl mb-2">💰</div>
                        <div className="font-bold text-gray-900">Pricing</div>
                        <div className="text-sm text-gray-700">View plans</div>
                    </Link>
                    <Link href="/refund" className="bg-white rounded-xl p-6 shadow-md border border-blue-100 hover:shadow-lg hover:border-blue-300 transition">
                        <div className="text-3xl mb-2">🔄</div>
                        <div className="font-bold text-gray-900">Refunds</div>
                        <div className="text-sm text-gray-700">30-day policy</div>
                    </Link>
                    <a href="mailto:support@descriptai.com" className="bg-white rounded-xl p-6 shadow-md border border-blue-100 hover:shadow-lg hover:border-blue-300 transition">
                        <div className="text-3xl mb-2">📧</div>
                        <div className="font-bold text-gray-900">Email Us</div>
                        <div className="text-sm text-gray-700">Get support</div>
                    </a>
                    <Link href="/generate" className="bg-white rounded-xl p-6 shadow-md border border-blue-100 hover:shadow-lg hover:border-blue-300 transition">
                        <div className="text-3xl mb-2">🚀</div>
            ...
            <section className="container mx-auto px-4 py-16">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-gradient-to-br from-blue-700 to-cyan-600 rounded-3xl p-8 md:p-12 text-white text-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                                ...
                                <a href="mailto:support@descriptai.com" className="text-blue-200 hover:text-white transition">
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                                ...
                                <a href="https://twitter.com/descriptai" target="_blank" rel="noopener noreferrer" className="text-blue-200 hover:text-white transition">
                                    @descriptai
                                </a>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                                ...
                                <a href="https://linkedin.com/company/descriptai" target="_blank" rel="noopener noreferrer" className="text-blue-200 hover:text-white transition">
                                    DescriptAI
                                </a>
                            </div>
                        </div>
