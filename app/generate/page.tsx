                ...
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-5 sm:p-8 h-fit border border-amber-50">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input value={productName} onChange={e => setProductName(e.target.value)} className="w-full px-4 py-3 rounded-xl border border-gray-100 focus:border-red-600 focus:ring-2 focus:ring-red-200 outline-none transition" placeholder="e.g. Arabica Coffee Beans" />
                        </div>
                        <div>
                            <label className="block text-xs font-bold text-gray-700 uppercase mb-2">Key Features</label>
                            <textarea value={features} onChange={e => setFeatures(e.target.value)} className="w-full px-4 py-3 rounded-xl border border-gray-100 focus:border-red-600 focus:ring-2 focus:ring-red-200 outline-none transition h-32" placeholder="e.g. Organic, strong aroma, fair trade..." />
                        </div>
