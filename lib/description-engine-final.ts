...
function getDefaultValues(category: string, features: string[]): Record<string, string> {
  ...
  const baseDefaults: Record<string, string> = {
    ...
    traditionalMethod: 'time-honored techniques',
    ...
    traditionalMethod: 'time-honored methods',
  ...
  const categorySpecific: Record<string, Record<string, string>> = {
    ...
    pets: {
      petPremiumMaterial: 'human-grade materials',
      petHealthBenefits: 'Optimal health benefits'
    },
    books: {
      bookPremiumMaterial: 'archival-quality paper'
    },
    art: {
    ...
    automotive: {
      autoPremiumMaterial: 'OEM-grade materials'
    },
    jewelry: {
      jewelPremiumMaterial: 'precious metals and gems',
      jewelryComfort: 'All-day comfort',
      jewelryTestimonial: 'Customers treasure it',
      jewelryMeaning: 'Deep personal meaning'
    },
    office: {
      officePremiumMaterial: 'executive-grade materials',
      officeTestimonial: 'Professionals love it'
    },
    outdoor: {
      outPremiumMaterial: 'expedition-grade materials',
      outdoorActivity: 'outdoor adventures',
      outdoorFeature: 'essential features'
    },
    food: {
      foodPremiumMaterial: 'heritage ingredients'
    },
    gaming: {
      gamePremiumMaterial: 'tournament-grade components',
    ...
    gifts: {
      giftPremiumMaterial: 'luxury gift materials'
    },
    health: {
      healthPremiumMaterial: 'pharmaceutical-grade ingredients'
    },
    music: {
      musicPremiumMaterial: 'concert-hall quality materials'
    },
    photography: {
      photoPremiumMaterial: 'broadcast-grade components'
    }
  };
